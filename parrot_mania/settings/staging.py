...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['office.parrot-mania.test.parrotmania.com', 'parrot-mania.test.parrotmania.com'])

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str('RAZZLE_SITE_URL', default='https://parrot-mania.test.parrotmania.com')
DJANGO_SITE_URL = env.str('RAZZLE_BACKEND_SITE_URL', default='https://office.parrot-mania.test.parrotmania.com')

CSRF_COOKIE_DOMAIN = env.str('DJANGO_CSRF_COOKIE_DOMAIN', default='.parrot-mania.test.parrotmania.com')
